      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-lg">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <Button
              onClick={login}
              className="w-full flex items-center justify-center space-x-2 py-6 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors"
            >
            ...
            <p className="text-xs text-center text-gray-500">
              লগইন করার মাধ্যমে আপনি আমাদের <a href="#" className="text-bangladesh-green hover:underline">নিয়ম ও শর্তাবলী</a> মেনে নিচ্ছেন।
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 text-center text-sm">
          <p className="text-gray-600">
            &copy; ২০২৫ আইকন বাংলাদেশ। সর্বস্বত্ব সংরক্ষিত।
          </p>
        </div>
      </div>
    </div>
